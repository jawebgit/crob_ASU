...
typedef struct ankle_ob_s {                      // ankle world coordinates
    ...
    f64 target_Distance_IE;    // JA (20200129)
    f64 target_Distance_DP;    // JA (20200129)
    u32 gravityCompMode;  // HL (20160606)	
...
// single dim arrays are easier to handle here.
    ...
    f64 *adcvolts;
    f64 *adcvolts1; // YR [20190309]
    f64 *adcvolts2; // YR [20190309]
    f64 *adcvolts3; // YR [20190309]
    f64 *dacvolts;
