...
ankle_ctl(u32 id)
{
    ...
    // wall lrtb
    // HL (20170113) change from 2 to 4	
    w2 = w / 4.0;
    h2 = h / 4.0;
    l = ie - w2;
    r = ie + w2;
  ...
  //  TDP = tdp;
    TDP = tdp+ob->ankle.gravityTorque;
...
ankle_stiff_ctl(u32 id)
{
    ...
    pos_equil_DP = DP - ob->ankle.stiff_center.dp - ob->ankle.ref_pos.dp;
    pos_equil_IE = IE - ob->ankle.stiff_center.ie - ob->ankle.ref_pos.ie;
