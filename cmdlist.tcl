...
set cmdlist {
    ...
    {so_f64 emg1 &daq->m_adcvolts[0][0] 64}
    {so_f64 emg2 &daq->m_adcvolts[0][1] 64}
    {so_f64 emg3 &daq->m_adcvolts[0][2] 64}
    {so_f64 emg4 &daq->m_adcvolts[0][3] 64}
    ...
    {so_s32 can_value &rob->can.value 1}
