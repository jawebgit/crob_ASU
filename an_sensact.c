...
ankle_init(void)
{
    ...
    ob->ankle.accel.ie = 0.0;
    ob->ankle.faccel.ie = 0.0;
    ob->ankle.torque.ie = 0.0;

    ob->ankle.pos.dp = 0.0;
    ob->ankle.vel.dp = 0.0;
    ob->ankle.fvel.dp = 0.0;
    ob->ankle.accel.dp = 0.0;
    ob->ankle.faccel.dp = 0.0;
    ...
    prev->ankle.accel.ie = 0.0;
    prev->ankle.faccel.ie = 0.0;

    prev->ankle.pos.dp = 0.0;
    prev->ankle.vel.dp = 0.0;
    prev->ankle.fvel.dp = 0.0;
    prev->ankle.accel.dp = 0.0;
    prev->ankle.faccel.dp = 0.0;
}
...
ankle_calc_vel(void)
{
    ...
    ob->ankle.faccel.ie = butter(ob->ankle.accel.ie, prev->ankle.accel.ie, prev->ankle.faccel.ie);
    ob->ankle.faccel.dp = butter(ob->ankle.accel.dp, prev->ankle.accel.dp, prev->ankle.faccel.dp);
...
dac_ankle_actuator(void)
{
    ...
    if(ob->stiff>0){ // Actuator coordinate control mode
	devtrq.l = 0;
        devtrq.r = 0;
	...
	if (ob->vibrate) {
	  ...
	  cmdDevtrq = devtrq;        
	  cmdForce.r = cmdDevtrq.r * 2 * M_PI / rob->ankle.trans.lead;
	  cmdForce.l = cmdDevtrq.l * 2 * M_PI / rob->ankle.trans.lead;
	  cmdVolts.r = cmdDevtrq.r / rob->ankle.right.xform;
	  cmdVolts.l = cmdDevtrq.l / rob->ankle.left.xform;
	}
        // Calculate the force considering the stiffness of Anklebot
        rob->ankle.left.force =-(ob->stiff*rob->ankle.left.disp);
        devtrq.l -=rob->ankle.left.force*rob->ankle.trans.lead/(2*M_PI);
        rob->ankle.right.force =-(ob->stiff*rob->ankle.right.disp);
        devtrq.r -=rob->ankle.right.force*rob->ankle.trans.lead/(2*M_PI);
    }else{ // Joint coordinate control mode
	devtrq.l = (-ob->ankle.torque.dp / rob->ankle.trans.ankle_ball_length
	    + ob->ankle.torque.ie / (rob->ankle.trans.ball_ball_width/2))
	    * (rob->ankle.trans.lead / (4. * M_PI));
	devtrq.r = (-ob->ankle.torque.dp / rob->ankle.trans.ankle_ball_length
    ...
    if((ob->stiff==0) && (ob->ankle.stiff==0)){
	devtrq.l = 0;
        devtrq.r = 0;
    }
    // command voltages
    ...
    // Change inputs, so logs are correct 
    if (ob->stiff>0){
      rob->ankle.left.devtrq = cmdDevtrq.l;
      rob->ankle.right.devtrq = cmdDevtrq.r;
      rob->ankle.left.force = cmdForce.l;
      rob->ankle.right.force = cmdForce.r;
      rob->ankle.left.volts = cmdVolts.l;
      rob->ankle.right.volts = cmdVolts.r;
    }else{
      rob->ankle.left.devtrq = rob->ankle.left.volts * rob->ankle.left.xform;
      rob->ankle.right.devtrq = rob->ankle.right.volts * rob->ankle.right.xform;
    }
...
ankle_after_compute_controls(void)
{
    ...
    prev->ankle.faccel = ob->ankle.faccel;
